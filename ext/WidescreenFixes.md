* https://github.com/ThirteenAG/WidescreenFixesPack.git
...
DWORD WINAPI Init(LPVOID bDelay)
{
    ...
    pattern = hook::pattern("D9 44 24 0C D8 44 24 10 8B 44 24 08 8B 54 24 10 8B C8");
    ...
    if (nImproveGamepadSupport)
    {
        ...
        injector::WriteMemory(pattern.count(2).get(1).get<uint32_t>(7 + 5), 0x900004C2, true);
        ...
        }; injector::MakeInline<CatchPad>(pattern.count(2).get(1).get<uint32_t>(7));
