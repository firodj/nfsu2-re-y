...
static Enums_3(id) {
	...
	id = add_enum(-1,"D3DRESOURCETYPE",0x1100000);
	add_enum_member(id,"D3DRTYPE_SURFACE",	0X1,	-1);
	add_enum_member(id,"D3DRTYPE_VOLUME",	0X2,	-1);
	add_enum_member(id,"D3DRTYPE_TEXTURE",	0X3,	-1);
	add_enum_member(id,"D3DRTYPE_VOLUMETEXTURE",	0X4,	-1);
	add_enum_member(id,"D3DRTYPE_CUBETEXTURE",	0X5,	-1);
	add_enum_member(id,"D3DRTYPE_VERTEXBUFFER",	0X6,	-1);
	add_enum_member(id,"D3DRTYPE_INDEXBUFFER",	0X7,	-1);
	add_enum_member(id,"D3DRTYPE_FORCE_DWORD",	0X7FFFFFFF,	-1);
	id = add_enum(-1,"D3DPOOL",0x1100000);
	add_enum_member(id,"D3DPOOL_DEFAULT",	0,	-1);
	add_enum_member(id,"D3DPOOL_MANAGED",	0X1,	-1);
	add_enum_member(id,"D3DPOOL_SYSTEMMEM",	0X2,	-1);
	add_enum_member(id,"D3DPOOL_SCRATCH",	0X3,	-1);
	add_enum_member(id,"D3DPOOL_FORCE_DWORD",	0X7FFFFFFF,	-1);
	return id;
}
...
static ApplyStrucTInfos_0(void) {
	...
	SetType(get_member_id(id, 0x0), "int");
	SetType(get_member_id(id, 0x4), "char *");
	id = get_struc_id("SomeScannerConfig");
	SetType(get_member_id(id, 0x8), "enum JOYID");
	id = get_struc_id("JoyHandlerData");
	SetType(get_member_id(id, 0x8), "char *");
	id = get_struc_id("JoystickEventNode");
	SetType(get_member_id(id, 0x0), "ObjectLink");
	SetType(get_member_id(id, 0x8), "enum JOYID");
	SetType(get_member_id(id, 0xC), "SomeScannerConfig *");
	...
	SetType(get_member_id(id, 0x5C), "float");
	id = get_struc_id("IDirectInput8A");
	SetType(get_member_id(id, 0x0), "struct IDirectInput8AVtbl *");
	id = get_struc_id("DIACTIONFORMAT");
	SetType(get_member_id(id, 0x0), "DWORD");
	SetType(get_member_id(id, 0x4), "DWORD");
	SetType(get_member_id(id, 0x8), "DWORD");
	SetType(get_member_id(id, 0xC), "DWORD");
	SetType(get_member_id(id, 0x10), "LPDIACTIONA");
	SetType(get_member_id(id, 0x14), "GUID");
	SetType(get_member_id(id, 0x24), "DWORD");
	SetType(get_member_id(id, 0x28), "DWORD");
	SetType(get_member_id(id, 0x2C), "LONG");
	SetType(get_member_id(id, 0x30), "LONG");
	SetType(get_member_id(id, 0x34), "HINSTANCE");
	SetType(get_member_id(id, 0x38), "FILETIME");
	SetType(get_member_id(id, 0x40), "DWORD");
	SetType(get_member_id(id, 0x44), "CHAR[260]");
	id = get_struc_id("DIDEVICEINSTANCE");
	SetType(get_member_id(id, 0x0), "DWORD");
	SetType(get_member_id(id, 0x4), "GUID");
	SetType(get_member_id(id, 0x14), "GUID");
	SetType(get_member_id(id, 0x24), "DWORD");
	SetType(get_member_id(id, 0x28), "CHAR[260]");
	SetType(get_member_id(id, 0x12C), "CHAR[260]");
	SetType(get_member_id(id, 0x230), "GUID");
	SetType(get_member_id(id, 0x240), "WORD");
	SetType(get_member_id(id, 0x242), "WORD");
	id = get_struc_id("IDirectInputDevice8AVtbl");
	SetType(get_member_id(id, 0x0), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, const IID *const riid, LPVOID *ppvObj)");
	SetType(get_member_id(id, 0x4), "ULONG (__stdcall *)(IDirectInputDevice8A *This)");
	SetType(get_member_id(id, 0x8), "ULONG (__stdcall *)(IDirectInputDevice8A *This)");
	SetType(get_member_id(id, 0xC), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, LPDIDEVCAPS)");
	SetType(get_member_id(id, 0x10), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, LPDIENUMDEVICEOBJECTSCALLBACKA, LPVOID, DWORD)");
	SetType(get_member_id(id, 0x14), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, const GUID *const, LPDIPROPHEADER)");
	SetType(get_member_id(id, 0x18), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, const GUID *const, LPCDIPROPHEADER)");
	SetType(get_member_id(id, 0x1C), "HRESULT (__stdcall *)(IDirectInputDevice8A *This)");
	SetType(get_member_id(id, 0x20), "HRESULT (__stdcall *)(IDirectInputDevice8A *This)");
	SetType(get_member_id(id, 0x24), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, DWORD, LPVOID)");
	SetType(get_member_id(id, 0x28), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, DWORD, LPDIDEVICEOBJECTDATA, LPDWORD, DWORD)");
	SetType(get_member_id(id, 0x2C), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, LPCDIDATAFORMAT)");
	SetType(get_member_id(id, 0x30), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, HANDLE)");
	SetType(get_member_id(id, 0x34), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, HWND, DWORD)");
	SetType(get_member_id(id, 0x38), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, LPDIDEVICEOBJECTINSTANCEA, DWORD, DWORD)");
	SetType(get_member_id(id, 0x3C), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, LPDIDEVICEINSTANCEA)");
	SetType(get_member_id(id, 0x40), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, HWND, DWORD)");
	SetType(get_member_id(id, 0x44), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, HINSTANCE, DWORD, const GUID *const)");
	SetType(get_member_id(id, 0x48), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, const GUID *const, LPCDIEFFECT, LPDIRECTINPUTEFFECT *, LPUNKNOWN)");
	SetType(get_member_id(id, 0x4C), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, LPDIENUMEFFECTSCALLBACKA, LPVOID, DWORD)");
	SetType(get_member_id(id, 0x50), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, LPDIEFFECTINFOA, const GUID *const)");
	SetType(get_member_id(id, 0x54), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, LPDWORD)");
	SetType(get_member_id(id, 0x58), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, DWORD)");
	SetType(get_member_id(id, 0x5C), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, LPDIENUMCREATEDEFFECTOBJECTSCALLBACK, LPVOID, DWORD)");
	SetType(get_member_id(id, 0x60), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, LPDIEFFESCAPE)");
	SetType(get_member_id(id, 0x64), "HRESULT (__stdcall *)(IDirectInputDevice8A *This)");
	SetType(get_member_id(id, 0x68), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, DWORD, LPCDIDEVICEOBJECTDATA, LPDWORD, DWORD)");
	SetType(get_member_id(id, 0x6C), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, LPCSTR, LPDIENUMEFFECTSINFILECALLBACK, LPVOID, DWORD)");
	SetType(get_member_id(id, 0x70), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, LPCSTR, DWORD, LPDIFILEEFFECT, DWORD)");
	SetType(get_member_id(id, 0x74), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, LPDIACTIONFORMATA, LPCSTR, DWORD)");
	SetType(get_member_id(id, 0x78), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, LPDIACTIONFORMATA, LPCSTR, DWORD)");
	SetType(get_member_id(id, 0x7C), "HRESULT (__stdcall *)(IDirectInputDevice8A *This, LPDIDEVICEIMAGEINFOHEADERA)");
	return id;
}

static ApplyStrucTInfos_1(void) {
        auto id;
	id = get_struc_id("IDirectInputDevice8A");
	SetType(get_member_id(id, 0x0), "struct IDirectInputDevice8AVtbl *");
	id = get_struc_id("DIDEVICEOBJECTINSTANCE");
	SetType(get_member_id(id, 0x0), "DWORD");
	SetType(get_member_id(id, 0x4), "GUID");
	SetType(get_member_id(id, 0x14), "DWORD");
	SetType(get_member_id(id, 0x18), "DWORD");
	SetType(get_member_id(id, 0x1C), "DWORD");
	SetType(get_member_id(id, 0x20), "CHAR[260]");
	SetType(get_member_id(id, 0x124), "DWORD");
	SetType(get_member_id(id, 0x128), "DWORD");
	SetType(get_member_id(id, 0x12C), "WORD");
	SetType(get_member_id(id, 0x12E), "WORD");
	SetType(get_member_id(id, 0x130), "WORD");
	SetType(get_member_id(id, 0x132), "WORD");
	SetType(get_member_id(id, 0x134), "DWORD");
	SetType(get_member_id(id, 0x138), "WORD");
	SetType(get_member_id(id, 0x13A), "WORD");
	id = get_struc_id("DIPROPHEADER");
	SetType(get_member_id(id, 0x0), "DWORD");
	SetType(get_member_id(id, 0x4), "DWORD");
	SetType(get_member_id(id, 0x8), "DWORD");
	SetType(get_member_id(id, 0xC), "DWORD");
	id = get_struc_id("DIDEVICEINSTANCEA");
	SetType(get_member_id(id, 0x0), "DWORD");
	SetType(get_member_id(id, 0x4), "GUID");
	SetType(get_member_id(id, 0x14), "GUID");
	SetType(get_member_id(id, 0x24), "DWORD");
	...
	SetType(get_member_id(id, 0x24), "DWORD");
	SetType(get_member_id(id, 0x28), "DWORD");
	id = get_struc_id("DIDEVICEOBJECTINSTANCEA");
	SetType(get_member_id(id, 0x0), "DWORD");
	SetType(get_member_id(id, 0x4), "GUID");
	SetType(get_member_id(id, 0x14), "DWORD");
	SetType(get_member_id(id, 0x18), "DWORD");
	...
	SetType(get_member_id(id, 0x138), "WORD");
	SetType(get_member_id(id, 0x13A), "WORD");
	id = get_struc_id("D3DLOCKED_RECT");
	SetType(get_member_id(id, 0x0), "INT");
	SetType(get_member_id(id, 0x4), "void *");
	id = get_struc_id("D3DSURFACE_DESC");
	SetType(get_member_id(id, 0x0), "D3DFORMAT");
	SetType(get_member_id(id, 0x4), "D3DRESOURCETYPE");
	SetType(get_member_id(id, 0x8), "DWORD");
	SetType(get_member_id(id, 0xC), "D3DPOOL");
	SetType(get_member_id(id, 0x10), "D3DMULTISAMPLE_TYPE");
	SetType(get_member_id(id, 0x14), "DWORD");
	SetType(get_member_id(id, 0x18), "UINT");
	SetType(get_member_id(id, 0x1C), "UINT");
	id = get_struc_id("DIEFFECT");
	SetType(get_member_id(id, 0x0), "DWORD");
	SetType(get_member_id(id, 0x4), "DWORD");
	SetType(get_member_id(id, 0x8), "DWORD");
	SetType(get_member_id(id, 0xC), "DWORD");
	...
	SetType(get_member_id(id, 0x18), "DWORD");
	SetType(get_member_id(id, 0x1C), "DWORD");
	SetType(get_member_id(id, 0x20), "LPDWORD");
	SetType(get_member_id(id, 0x24), "LPLONG");
	SetType(get_member_id(id, 0x28), "LPDIENVELOPE");
	SetType(get_member_id(id, 0x2C), "DWORD");
	SetType(get_member_id(id, 0x30), "LPVOID");
	id = get_struc_id("DIENVELOPE");
	SetType(get_member_id(id, 0x0), "DWORD");
	SetType(get_member_id(id, 0x4), "DWORD");
	SetType(get_member_id(id, 0x8), "DWORD");
	SetType(get_member_id(id, 0xC), "DWORD");
	SetType(get_member_id(id, 0x10), "DWORD");
	id = get_struc_id("IDirectInputEffectVtbl");
	SetType(get_member_id(id, 0x0), "HRESULT (__stdcall *)(IDirectInputEffect *This, const IID *const riid, LPVOID *ppvObj)");
	SetType(get_member_id(id, 0x4), "ULONG (__stdcall *)(IDirectInputEffect *This)");
	SetType(get_member_id(id, 0x8), "ULONG (__stdcall *)(IDirectInputEffect *This)");
	SetType(get_member_id(id, 0xC), "HRESULT (__stdcall *)(IDirectInputEffect *This, HINSTANCE, DWORD, const GUID *const)");
	SetType(get_member_id(id, 0x10), "HRESULT (__stdcall *)(IDirectInputEffect *This, LPGUID)");
	SetType(get_member_id(id, 0x14), "HRESULT (__stdcall *)(IDirectInputEffect *This, LPDIEFFECT, DWORD)");
	SetType(get_member_id(id, 0x18), "HRESULT (__stdcall *)(IDirectInputEffect *This, LPCDIEFFECT, DWORD)");
	SetType(get_member_id(id, 0x1C), "HRESULT (__stdcall *)(IDirectInputEffect *This, DWORD, DWORD)");
	SetType(get_member_id(id, 0x20), "HRESULT (__stdcall *)(IDirectInputEffect *This)");
	SetType(get_member_id(id, 0x24), "HRESULT (__stdcall *)(IDirectInputEffect *This, LPDWORD)");
	SetType(get_member_id(id, 0x28), "HRESULT (__stdcall *)(IDirectInputEffect *This)");
	SetType(get_member_id(id, 0x2C), "HRESULT (__stdcall *)(IDirectInputEffect *This)");
	SetType(get_member_id(id, 0x30), "HRESULT (__stdcall *)(IDirectInputEffect *This, LPDIEFFESCAPE)");
	return id;
}
...
static Structures_0(id) {
	...
	id = add_struc(-1,"SomeScannerConfig",0);
	...
	id = add_struc(-1,"ShiftPattern",0);
	id = add_struc(-1,"IDirectInput8A",0);
	id = add_struc(-1,"DIACTIONFORMAT",0);
	id = add_struc(-1,"DIDEVICEINSTANCE",0);
	id = add_struc(-1,"IDirectInputDevice8AVtbl",0);
	id = add_struc(-1,"IDirectInputDevice8A",0);
	id = add_struc(-1,"DIDEVICEOBJECTINSTANCE",0);
	id = add_struc(-1,"DIPROPHEADER",0);
	id = add_struc(-1,"DIDEVICEINSTANCEA",0);
	id = add_struc(-1,"DIDEVCAPS",0);
	id = add_struc(-1,"DIDEVICEOBJECTINSTANCEA",0);
	id = add_struc(-1,"D3DLOCKED_RECT",0);
	id = add_struc(-1,"D3DSURFACE_DESC",0);
	id = add_struc(-1,"DIEFFECT",0);
	id = add_struc(-1,"DIENVELOPE",0);
	id = add_struc(-1,"IDirectInputEffectVtbl",0);
...
static Structures_4(id) {
	...
	id = get_struc_id("SomeScannerConfig");
	mid = add_struc_member(id,"joyConfigType",	0,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"unk1",	0X4,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"joyId",	0X8,	0x28800400,	get_enum("JOYID"),	4);
	mid = add_struc_member(id,"scannerFunctionPointer",	0XC,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"bitmaskStuff",	0X10,	0x10000400,	-1,	2);
	mid = add_struc_member(id,"bitmaskStuff2",	0X12,	0x10000400,	-1,	2);
	mid = add_struc_member(id,"unk2",	0X14,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"param",	0X18,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"keycode",	0X1C,	0x20000400,	-1,	4);
	...
	mid = add_struc_member(id,"joyId",	0X8,	0x28800400,	get_enum("JOYID"),	4);
	mid = add_struc_member(id,"scannerConfig",	0XC,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"proc",	0X10,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	...
	id = get_struc_id("ShiftPattern");
	mid = add_struc_member(id,"BankName",	0,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"Unk1",	0X4,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"UnkFloat1",	0X8,	0x80000400,	-1,	4);
	mid = add_struc_member(id,"Unk2",	0XC,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"Unk3",	0X10,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"Unk4",	0X14,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"Unk5",	0X18,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"Unk6",	0X1C,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"UnkFloat2",	0X20,	0x80000400,	-1,	4);
	mid = add_struc_member(id,"Unk7",	0X24,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"Unk8",	0X28,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"Unk9",	0X2C,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"Unk10",	0X30,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"Unk11",	0X34,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"Unk12",	0X38,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"Unk13",	0X3C,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"UnkFloat3",	0X40,	0x80000400,	-1,	4);
	mid = add_struc_member(id,"Unk14",	0X44,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"Unk15",	0X48,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"Unk16",	0X4C,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"Unk17",	0X50,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"Unk18",	0X54,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"Unk19",	0X58,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"UnkFloat4",	0X5C,	0x80000400,	-1,	4);
	set_struc_align(id,2);
	...
	id = get_struc_id("DIACTIONFORMAT");
	mid = add_struc_member(id,"dwSize",	0,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwActionSize",	0X4,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwDataSize",	0X8,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwNumActions",	0XC,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"rgoAction",	0X10,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"guidActionMap",	0X14,	0x60000400,	get_struc_id("GUID"),	16);
	mid = add_struc_member(id,"dwGenre",	0X24,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwBufferSize",	0X28,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"lAxisMin",	0X2C,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"lAxisMax",	0X30,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"hInstString",	0X34,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"ftTimeStamp",	0X38,	0x60000400,	get_struc_id("FILETIME"),	8);
	mid = add_struc_member(id,"dwCRC",	0X40,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"tszActionMap",	0X44,	0x000400,	-1,	260);
	set_struc_align(id,2);
	
	id = get_struc_id("DIDEVICEINSTANCE");
	mid = add_struc_member(id,"dwSize",	0,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"guidInstance",	0X4,	0x60000400,	get_struc_id("GUID"),	16);
	mid = add_struc_member(id,"guidProduct",	0X14,	0x60000400,	get_struc_id("GUID"),	16);
	mid = add_struc_member(id,"dwDevType",	0X24,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"tszInstanceName",	0X28,	0x000400,	-1,	260);
	mid = add_struc_member(id,"tszProductName",	0X12C,	0x000400,	-1,	260);
	mid = add_struc_member(id,"guidFFDriver",	0X230,	0x60000400,	get_struc_id("GUID"),	16);
	mid = add_struc_member(id,"wUsagePage",	0X240,	0x10000400,	-1,	2);
	mid = add_struc_member(id,"wUsage",	0X242,	0x10000400,	-1,	2);
	set_struc_align(id,2);
	...
	mid = add_struc_member(id,"AddRef",	0X4,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"Release",	0X8,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"GetCapabilities",	0XC,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"EnumObjects",	0X10,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"GetProperty",	0X14,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"SetProperty",	0X18,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"Acquire",	0X1C,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"Unacquire",	0X20,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"GetDeviceState",	0X24,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"GetDeviceData",	0X28,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"SetDataFormat",	0X2C,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"SetEventNotification",	0X30,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"SetCooperativeLevel",	0X34,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"GetObjectInfo",	0X38,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"GetDeviceInfo",	0X3C,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"RunControlPanel",	0X40,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"Initialize",	0X44,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"CreateEffect",	0X48,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"EnumEffects",	0X4C,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"GetEffectInfo",	0X50,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"GetForceFeedbackState",	0X54,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"SendForceFeedbackCommand",	0X58,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"EnumCreatedEffectObjects",	0X5C,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"Escape",	0X60,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"Poll",	0X64,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"SendDeviceData",	0X68,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"EnumEffectsInFile",	0X6C,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"WriteEffectToFile",	0X70,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"BuildActionMap",	0X74,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"SetActionMap",	0X78,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"GetImageInfo",	0X7C,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	set_struc_align(id,2);
	...
	id = get_struc_id("DIDEVICEOBJECTINSTANCE");
	mid = add_struc_member(id,"dwSize",	0,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"guidType",	0X4,	0x60000400,	get_struc_id("GUID"),	16);
	mid = add_struc_member(id,"dwOfs",	0X14,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwType",	0X18,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwFlags",	0X1C,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"tszName",	0X20,	0x000400,	-1,	260);
	mid = add_struc_member(id,"dwFFMaxForce",	0X124,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwFFForceResolution",	0X128,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"wCollectionNumber",	0X12C,	0x10000400,	-1,	2);
	mid = add_struc_member(id,"wDesignatorIndex",	0X12E,	0x10000400,	-1,	2);
	mid = add_struc_member(id,"wUsagePage",	0X130,	0x10000400,	-1,	2);
	mid = add_struc_member(id,"wUsage",	0X132,	0x10000400,	-1,	2);
	mid = add_struc_member(id,"dwDimension",	0X134,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"wExponent",	0X138,	0x10000400,	-1,	2);
	mid = add_struc_member(id,"wReserved",	0X13A,	0x10000400,	-1,	2);
	set_struc_align(id,2);
	
	id = get_struc_id("DIPROPHEADER");
	mid = add_struc_member(id,"dwSize",	0,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwHeaderSize",	0X4,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwObj",	0X8,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwHow",	0XC,	0x20000400,	-1,	4);
	set_struc_align(id,2);
	...
	mid = add_struc_member(id,"dwDevType",	0X8,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwAxes",	0XC,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwButtons",	0X10,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwPOVs",	0X14,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwFFSamplePeriod",	0X18,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwFFMinTimeResolution",	0X1C,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwFirmwareRevision",	0X20,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwHardwareRevision",	0X24,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwFFDriverVersion",	0X28,	0x20000400,	-1,	4);
	set_struc_align(id,2);
	...
	id = get_struc_id("D3DLOCKED_RECT");
	mid = add_struc_member(id,"Pitch",	0,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"pBits",	0X4,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	set_struc_align(id,2);
	
	id = get_struc_id("D3DSURFACE_DESC");
	mid = add_struc_member(id,"Format",	0,	0x28800400,	get_enum("D3DFORMAT"),	4);
	mid = add_struc_member(id,"Type",	0X4,	0x28800400,	get_enum("D3DRESOURCETYPE"),	4);
	mid = add_struc_member(id,"Usage",	0X8,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"Pool",	0XC,	0x28800400,	get_enum("D3DPOOL"),	4);
	mid = add_struc_member(id,"MultiSampleType",	0X10,	0x28800400,	get_enum("D3DMULTISAMPLE_TYPE"),	4);
	mid = add_struc_member(id,"MultiSampleQuality",	0X14,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"Width",	0X18,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"Height",	0X1C,	0x20000400,	-1,	4);
	set_struc_align(id,2);
	
	id = get_struc_id("DIEFFECT");
	mid = add_struc_member(id,"dwSize",	0,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwFlags",	0X4,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwDuration",	0X8,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwSamplePeriod",	0XC,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwGain",	0X10,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwTriggerButton",	0X14,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwTriggerRepeatInterval",	0X18,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"cAxes",	0X1C,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"rgdwAxes",	0X20,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"rglDirection",	0X24,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"lpEnvelope",	0X28,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"cbTypeSpecificParams",	0X2C,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"lpvTypeSpecificParams",	0X30,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"dwStartDelay",	0X34,	0x20000400,	-1,	4);
	set_struc_align(id,2);
	
	id = get_struc_id("DIENVELOPE");
	mid = add_struc_member(id,"dwSize",	0,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwAttackLevel",	0X4,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwAttackTime",	0X8,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwFadeLevel",	0XC,	0x20000400,	-1,	4);
	mid = add_struc_member(id,"dwFadeTime",	0X10,	0x20000400,	-1,	4);
	set_struc_align(id,2);
	...
	mid = add_struc_member(id,"AddRef",	0X4,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"Release",	0X8,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"Initialize",	0XC,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"GetEffectGuid",	0X10,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"GetParameters",	0X14,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"SetParameters",	0X18,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"Start",	0X1C,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"Stop",	0X20,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"GetEffectStatus",	0X24,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"Download",	0X28,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"Unload",	0X2C,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = add_struc_member(id,"Escape",	0X30,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	set_struc_align(id,2);
	return id;
}
